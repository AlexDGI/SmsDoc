  ...
  if($params->Referencia != '') 
  {
    ...
    */
    mysqli_query($con,"insert into recargas(IdFiscal, Fecha, FecTransaccion, FecVerificacion, Forma, Referencia, Monto, Banco, Cuenta, CantidSms, UsrVerifico, Estado) values
                  ($IdFiscal,'$params->Fecha','$params->FecTransaccion','$params->FecVerificacion','$params->Forma','$params->Referencia',$params->Monto,'$params->Banco','$params->Cuenta', $params->CantidSms,'$params->UsrVerifico','$params->Estado')");
